                    ...
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-gray-100 mb-8">
                            ...
                            <div className="bg-gray-50 rounded-xl p-5 text-center mb-4">
                                <p className="font-mono text-lg font-bold text-[#090a3d]">M = P Ã— [(1 + i)<sup>n</sup> − 1] / i Ã— (1 + i)</p>
                            </div>
                ...
                <section className="py-16 bg-white">
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                { icon: 'ðŸ“…', title: 'Monthly SIP', desc: 'The most common format ”” invest a fixed amount every month. Compounding applies monthly, making it ideal for salaried individuals.' },
                                ...
                                { icon: 'ðŸŽ¯', title: 'Goal-Based SIP', desc: 'Plan SIP based on a financial goal ”” buying a house, child education, or retirement. Find required monthly SIP to reach your goal.' },
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                { icon: 'ðŸ”§', title: 'Flexible & Simple', desc: 'Start with as low as ₹100/month. Increase, pause, or stop anytime without penalties.' },
                            ].map((benefit, i) => (
