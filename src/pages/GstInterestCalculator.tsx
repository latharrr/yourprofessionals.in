...
const GST_RETURN_DATES = [
    ...
    { returnType: 'GSTR-1', frequency: 'Quarterly (IFF)', dueDate: '13th of month after quarter', applicability: 'Turnover â‰¤ ₹5 Cr under QRMP scheme' },
    { returnType: 'GSTR-3B', frequency: 'Monthly', dueDate: '20th of next month', applicability: 'Turnover > ₹5 Cr' },
    { returnType: 'GSTR-3B', frequency: 'Quarterly', dueDate: '22nd/24th of month after quarter', applicability: 'Turnover â‰¤ ₹5 Cr under QRMP scheme' },
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[
                                ...
                                { icon: 'ðŸ’°', title: 'Maintain Sufficient Cash Balance', desc: 'Ensure your electronic cash ledger has adequate funds before the due date. Deposit money at least 2–3 days before the deadline to account for bank processing delays.' },
