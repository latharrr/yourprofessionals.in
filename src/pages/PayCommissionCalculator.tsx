...
const FAQ_DATA = [
  ...
  },
  {
    ...
    a: 'The new basic pay is calculated by multiplying your current basic pay by the fitment factor. For example, if your current basic pay is ₹56,100 and the fitment factor is 2.86x, your expected new basic pay would be ₹56,100 Ã— 2.86 = ₹1,60,446.',
  },
  {
        ...
        <section className="py-12 md:py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                { icon: 'ðŸ’°', title: 'Revised Minimum Pay', desc: 'The minimum basic pay is expected to rise from ₹18,000 to approximately ₹51,480 (at 2.86x). Employee unions have demanded a pre-fitment base of ₹26,000.' },
                ...
                { icon: 'ðŸ¦', title: 'Pension Revision', desc: 'All pensioners under the old pension scheme (OPS) are expected to receive revised pension amounts. The minimum pension may increase from ₹9,000 to over ₹25,000 per month.' },
                ...
                { icon: 'ðŸ”„', title: 'DA Merger & Reset', desc: 'At implementation, the accumulated Dearness Allowance is expected to be merged into the new basic pay, and the DA percentage will reset to 0% ”” a standard practice with every pay commission.' },
              ].map((item) => (
