                    ...
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="bg-white rounded-2xl p-6 md:p-8 shadow-lg border border-gray-100 mb-8">
                            ...
                            <div className="bg-gray-50 rounded-xl p-5 text-center mb-4">
                                <p className="font-mono text-lg font-bold text-[#090a3d]">EMI = P Ã— r Ã— (1 + r)<sup>n</sup> / ((1 + r)<sup>n</sup> − 1)</p>
                            </div>
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {[
                                ...
                                { icon: 'ðŸ’µ', title: 'Increase Down Payment', desc: 'Pay 25–30% upfront instead of the minimum 10–20%. A smaller loan means a smaller EMI and less total interest over the life of the loan.' },
                                ...
                                { icon: 'ðŸ“…', title: 'Choose a Shorter Tenure', desc: 'If your monthly budget allows, pick 15 years over 20. The EMI is higher but total interest drops dramatically ”” often saving ₹10 lakh or more.' },
