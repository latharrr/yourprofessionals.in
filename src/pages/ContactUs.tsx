...
export default function ContactUs() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        setFormData({ name: '', email: '', phone: '', service: '', customService: '', message: '' });
    };
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <div className="text-center max-w-3xl mx-auto">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <a href="https://wa.me/919354332511" target="_blank" rel="noopener noreferrer"
                            ...
                            <div className="space-y-6">
                                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100 hover:shadow-xl transition-shadow">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="tel:+917011936958" className="text-[var(--color-brand-secondary)] font-semibold text-lg hover:underline">+91-7011936958</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100 hover:shadow-xl transition-shadow">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            <h3 className="text-lg font-bold text-[#090a3d] mb-1">WhatsApp Us</h3>
                                            <p className="text-gray-500 text-sm mb-2">Instant Support Helpline</p>
                                            <a href="https://wa.me/919354332511" target="_blank" rel="noopener noreferrer" className="text-green-600 font-semibold text-lg hover:underline">+91 93543 32511</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100 hover:shadow-xl transition-shadow">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <a href="mailto:info@yourprofessionals.in" className="text-[var(--color-brand-secondary)] font-semibold hover:underline">info@yourprofessionals.in</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 border border-gray-100 hover:shadow-xl transition-shadow">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-gray-500 text-sm">Office No. 204, U-172, Street No.4, Laxmi Nagar, Block U, Shakarpur, Delhi, 110092</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div className="rounded-2xl overflow-hidden shadow-xl border border-gray-200 h-[400px]">
                            <iframe
                                ...
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3502.1332997787165!2d77.2772!3d28.6325!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390cfcf2c42c67d3%3A0x7d25e0e0e0e0e0e0!2sBlock+U%2C+Shakarpur%2C+Delhi+110092!5e0!3m2!1sen!2sin!4v1711000000000!5m2!1sen!2sin"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen
